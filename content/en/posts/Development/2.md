...
summary: "Weeks 1-2: refactored ASS subtitle handling to read/write more data, added embedded font support, optimized style storage, and migrated to V4+Style; next steps are data structure updates and tests."
